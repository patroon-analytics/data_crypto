...
class BinanceStreamProcessor:
    def __init__(self, ticker, dir_updates_root, db_ver, timezone="US/Eastern"):
        self.ticker = ticker
        ...
        logging.basicConfig(filename='binance_stream.log', level=logging.DEBUG, format='%(asctime)s %(message)s')
        self.d_thresh = {
                        'BTCUSDT' : 500000,
                        'ETHUSDT' : 100000,
                        'SOLUSDT' : 10000, 
...
# ==================================================================================
    ...
    def process_batches(self):
        while True:
            time.sleep(10)  # Sleep for one hour
...
if __name__ == "__main__":
    n_ticker = "BTCUSDT"
    n_dir_updates_root = os.path.join(os.getcwd(), "feather_files")
